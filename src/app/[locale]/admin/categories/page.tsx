...
import ManageCategoriesClient from '@/app/components/admin/manage-categories/ManageCategoriesClient';
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2 flex items-center">
                ...
                {t('AdminManageCategories.title')}
              </h1>
              <p className="text-gray-400 max-w-3xl">
                {t('AdminManageCategories.description')}
              </p>
              ...
              <div className="flex items-center space-x-2 mt-4 text-sm text-gray-400">
                ...
                <span>/</span>
                <span className="text-[#58a6ff]">{t('AdminManageCategories.title')}</span>
              </div>
            </div>
      ...
      <main className="flex-grow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="bg-gradient-to-br from-[#1a2239] to-[#1c2541] rounded-xl border border-[#30364a] shadow-2xl overflow-hidden">
            <div className="p-6">
              <ManageCategoriesClient locale={locale} />
            </div>
          </div>
        </div>
      </main>
